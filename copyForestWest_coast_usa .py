...
sourceFolder = "C:\\Users\\Administrator\\Desktop\\west_coast_usa\\forest"
targetFolder = "C:\\Users\\Administrator\\AppData\\Local\\BeamNG.drive\\0.29\\mods\\unpacked\\roadTrip\\levels\\road_trip\\forest"
...
for root, dirs, files in os.walk(sourceFolder): 
    for f in files:
        shutil.copyfile(root + "\\" + f, targetFolder + root[52:] + "\\" + f)
        move(targetFolder + root[52:], f)
